...
//		printf("car_system.atx:%f\tcar_system.chassis_dx:%f\r\n",car_system.atx,car_system.chassis_dx);
		...
		if(pic_flag.endline_flag!=0)
		{
			if(flap[0]==1)
			{
				...
				switch(end_dis)
				{
					case 0:car_system.atx=-10;car_system.aty=0;break;
					case 1:car_system.atx=-40;car_system.aty=0;break;
					case 2:car_system.atx=-40;car_system.aty=0;break;
...
//	}
	...
	else if(obj.x==0&&obj.y==0&&time.micro_distance_time>3)
	{
		if(flap[0]==5)
		{
			if(pic_flag.endline_flag==0)
...
void identify_card()
{
	...
	else if(obj.x==0&&obj.y==0&&time.identify_card_time>2)
	{
		flap[0]=8;
		obj.label=0;
		label1=0;
