	...
	if(ms100_3==10)
	{
		...
		if(flag.cross_round_card_over!=0)
		{
			...
			if(pic_flag.cross_all_flag!=0)
			{
				switch(turn_num)
				{
					case 0:if(time.cross_card_time>5)
					{
					...
					case 1:if(time.cross_card_time>4)
					{
						pic_flag.cross_all_flag=0;
						pic_flag.round_left_flag=0;
						pic_flag.round_right_flag=0;
					...
					case 2:if(time.cross_card_time>3)
					{
						pic_flag.cross_all_flag=0;
						pic_flag.round_left_flag=0;
						pic_flag.round_right_flag=0;
					...
					case 3:if(time.cross_card_time>2)
					{
						pic_flag.cross_all_flag=0;
						pic_flag.round_left_flag=0;
						pic_flag.round_right_flag=0;
